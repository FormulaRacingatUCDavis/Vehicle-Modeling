...
%Sprung mass
m_total = 237.6 + 70 - 4*mt; %kg, total mass of vehicle + Driver's weight
...
%Spring and damper
MR_f = 0.95; %Motion ratio at front
MR_r = 0.95; %Motion ratio at rear 
k_springf = 15060*(MR_f^2); %N/m, spring constant at front
r_damperf = 5000; %N.s/m damping constant at front
k_springr = 15410*(MR_r^2); %N/m, spring constant at rear
r_damperr = 1428.6; %N.s/m damping constant at rear
...
%yaw_rate_linear_0 = yaw_rate_linear
%m_total = 237.6 + 70
%sim('Vehicle_Dynamic_sim_V0629')

%plot(yaw_rate_linear_0,'b');
%hold on
%plot(yaw_rate_linear,'r');
%hold on
%plot(Yaw_CS,'black');
